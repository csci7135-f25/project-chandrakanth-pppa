...
\subsection{From Relational Bounds to Gradient Analysis}
...
\textbf{Linear Layers:} For a fully connected layer with a weight matrix $W$ and a bias vector $b$, the transformation is calculated exactly thanks to the linearity of the dual algebra. The affine expressions for value and gradient are transformed into:
\begin{align}
